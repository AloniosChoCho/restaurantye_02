    ...
    function n(e) {
        1 == t("#light-mode-switch").prop("checked") && "light-mode-switch" === e
            ? (t("html").removeAttr("dir"),
              ...
              t("#bootstrap-style").attr("href", "backend/css/bootstrap.min.css"),
              t("#app-style").attr("href", "backend/css/app.min.css"),
              sessionStorage.setItem("is_visited", "light-mode-switch"))
            : 1 == t("#dark-mode-switch").prop("checked") && "dark-mode-switch" === e
            ? (t("html").removeAttr("dir"),
              t("#light-mode-switch").prop("checked", !1),
              t("#rtl-mode-switch").prop("checked", !1),
              t("#bootstrap-style").attr("href", "backend/css/bootstrap-dark.min.css"),
              t("#app-style").attr("href", "backend/css/app-dark.min.css"),
