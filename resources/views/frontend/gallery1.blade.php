...
<section class="breadcrumb-area">
    ...
    <h3 class="page-title">Galería</h3>
    ...
    <div class="col-md-4">
    <div class="single-food-gallery">
    <a data-fancybox="gallery" href="{{ asset ('frontend/img/gallery/gFood-L-7.jpg') }} ">
    <img src="{{ asset ('frontend/img/gallery/gFood-7.jpg') }} " alt="">
    <h4>Pollo frito</h4>
    </a>
    </div>
    </div>
    <div class="col-md-4">
    <div class="single-food-gallery">
    <a data-fancybox="gallery" href="{{ asset ('frontend/img/gallery/gFood-L-8.jpg') }} ">
    <img src="{{ asset ('frontend/img/gallery/gFood-8.jpg') }} " alt="">
    <h4>Pollo frito</h4>
    </a>
    </div>
    </div>
    <div class="col-md-4">
    <div class="single-food-gallery">
    <a data-fancybox="gallery" href="{{ asset ('frontend/img/gallery/gFood-L-9.jpg') }} ">
    <img src="{{ asset ('frontend/img/gallery/gFood-9.jpg') }} " alt="">
    <h4>Pollo frito</h4>
    </a>
    </div>
    </div>
    <div class="col-md-4">
    <div class="single-food-gallery">
    <a data-fancybox="gallery" href="{{ asset ('frontend/img/gallery/gFood-L-10.jpg') }} ">
    <img src="{{ asset ('frontend/img/gallery/gFood-10.jpg') }} " alt="">
    <h4>Pollo frito</h4>
    </a>
    </div>
    </div>
    <div class="col-md-4">
    <div class="single-food-gallery">
    <a data-fancybox="gallery" href="{{ asset ('frontend/img/gallery/gFood-L-11.jpg') }} ">
    <img src="{{ asset ('frontend/img/gallery/gFood-11.jpg') }} " alt="">
    <h4>Pollo frito</h4>
    </a>
    </div>
    </div>
    <div class="col-md-4">
    <div class="single-food-gallery">
    <a data-fancybox="gallery" href="{{ asset ('frontend/img/gallery/gFood-L-12.jpg') }} ">
    <img src="{{ asset ('frontend/img/gallery/gFood-12.jpg') }} " alt="">
    <h4>Pollo frito</h4>
    </a>
    </div>
    </div>
