                ...
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <div class="page-title">
                            <h4 class="mb-0 font-size-18">Pagination</h4>
                            <ol class="breadcrumb">
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-title-desc">Pagination links indicate a series of related content
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-title-desc">Pagination links are customizable for
                                    different circumstances. Use <code class="highlighter-rouge">.disabled</code>
