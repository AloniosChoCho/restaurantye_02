                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-title-desc">Add <code
                                        class="highlighter-rouge">.dropdown-menu-right</code> to a <code
                                        class="highlighter-rouge">.dropdown-menu</code> to right align the dropdown
                                    menu.</p>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="card-title">Menu alignment</h4>
                                <p class="card-title-desc">Add <code
                                        class="highlighter-rouge">.dropdown-menu-end</code>
